...
@Using (Html.BeginForm()) 
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.Done, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                <div class="checkbox">
                    @Html.EditorFor(Function(model) model.Done)
                    @Html.ValidationMessageFor(Function(model) model.Done, "", New With { .class = "text-danger" })
                </div>
            </div>
        </div>
